...
WHERE k.kode_kulkas = '$refgr_id')q limit 1 ");
...
<div class="container-fluid">
    <div class="block-header">
        <h2>DETAIL DEVICE LOG
            <a href="index.php?page=ref_detail&rid=<?php echo $refgr_id ?>" type="button" class="btn bg-cyan waves-effect right">Back to Refrigerator Map</a>
        </h2>
    </div>
    </br>
