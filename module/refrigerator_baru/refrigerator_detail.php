...
l.cold_room,l.min_temp,l.max_temp
														...
														WHERE k.kode_kulkas = '$rfgr_id') where rownum = 1 ";
...
<div class="container-fluid">
            <div class="block-header">
                <h2>DETAIL INFO
                 <a href="index.php?page=refrigerator" type="button" class="btn bg-cyan waves-effect right">Back to Refrigerator Map</a></h2>
            </div>
