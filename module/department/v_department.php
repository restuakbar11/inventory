<head>
	...
	<style>
	 .restu{
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<a href="#" class="btn btn-success tambahdepartment"><i class="material-icons">add</i> Tambah Data</a></br></br>
                            <div class="restu"></div>
                        </div>
                    </div>
                </div>
        ...
        <!-- MODAL -->
        <div class="modal fade" id="modaldepartment" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-4 control-label">Nama Department*</label>
                        <div class="col-sm-8 ">
                            <div class="form-line">
                                <input type="text" class="form-control" name="nama_department" id="nama_department" >
                                <input type="hidden" name="username" id="username" value="<?php echo $username; ?>" >
                                <input type="hidden" name="act" id="act">
                                <input type="hidden" name="id_department" id="id_department"  class="form-control" >
                            </div>
                        </div></br>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-primary waves-effect" type="button" id="save" onclick="javascript:add_department();"></button>
