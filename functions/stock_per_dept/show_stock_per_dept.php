	...
	<table class="table table-bordered table-striped table-hover js-basic-example dataTable">
		...
		<tbody>
			...
			$user2 =$mysqli->query( "SELECT IDITEM,NAMAITEM,IDSATUAN,NAMASATUAN,SUM(ITEMSTOCK_STOCK) AS STOCK
										...
										WHERE ITEMSTOCK_IDDEPARTMENT='$id_department' AND ITEMSTOCK_STOCK>0
			...
			while ($r =mysqli_fetch_array($user2)) { 
				...
				<tr>
					...
					<td>
						<center>
						<a href="?page=stock_per_dept&act=detailstock&item=<?php echo $r['IDITEM']?>&sat=<?php echo $r['IDSATUAN']?>" class="btn btn-info">Detail <i class="fa fa-eye"></i></a>
